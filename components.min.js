(function () {
  ...
  function init() {
    ...
    if (hiwSection) {
      ...
      const tabsEl = hiwSection.querySelector('#hiwTabs');
      const panels = [...hiwSection.querySelectorAll('.panel')];
      const urlEl = hiwSection.querySelector('#deviceUrl');
      const screenEl = hiwSection.querySelector('#hiwScreen');
      ...
      if (tabsEl && panels.length > 0) {
        ...
        function showPanel(i) {
          ...
          if (screenEl) void screenEl.offsetWidth;
        ...
        const stage = hiwSection.querySelector('.stage');
        if (stage) {
