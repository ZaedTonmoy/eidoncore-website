    ...
    <section className="pt-20 pb-16 md:pt-28 md:pb-24 overflow-hidden">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-12">
          ...
          <Link
            href={eyebrowHref}
            className="inline-flex items-center gap-2 px-3 py-1 bg-white border border-[#E7E7EA] rounded-full text-xs font-medium text-[#0B0B0F] hover:border-[#3F72AF]/40 transition-colors mb-6 shadow-2xs group"
          >
          ...
          <AnimatedText
            text={subheadline}
            mode="word"
            className="mt-5 text-[#6B6F76] text-lg sm:text-xl leading-relaxed max-w-2xl"
          />
          ...
          {/* Trust bullets */}
          <div className="mt-6 flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-xs text-[#6B6F76]">
